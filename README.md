...
As of 2025-03-11, the RustSec Advisory Database contains 137 active advisories for unmaintained packages. Using the above conditions, `cargo-unmaintained` automatically identifies 101 (73%) of them. These results can be reproduced by running the [`rustsec_advisories`] example within this repository.
...
- Of the 36 packages in the RustSec Advisory Database _not_ identified by `cargo-unmaintained`:
  - 11 do not build
  - 3 are existent, unarchived leaves
  - 2 were updated within the past 365 days
  - 20 were not identified for other reasons
